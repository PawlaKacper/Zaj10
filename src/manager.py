...
class Manager:
    ...
    def get_apartment_costs(
        ...
        Args:
        ----
            apartment_key (str): Key to point exact apartment.
            year (int): The year from which the cost is calculated.
            month (int): The month from which the cost in year is calculated.

        Returns:
        -------
            float: The total cost of apartment
